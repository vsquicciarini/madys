...
* ModelHandler: handles data and metadata of the files in the /isochrone path, allowing one to inspect the locally available models and to download new ones. See HERE;
