...
of individual stars.
In its first release, MADYS allows a selection of one among 16 theoretical models,
    ...
    def available(cls,key=None,verbose=True):
        ...
        if type(key)==type(None):
            ...
            for i in i2: 
                ...
                print('# Mass range (M_sun): '+str(list(np.around(mass_list[i],4))))
